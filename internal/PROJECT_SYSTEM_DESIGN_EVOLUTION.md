...
> **2026-05-02:** Phase 0–3 narrative below was **restored from git** (`16f3a28`). Phase 4 API milestones are **appended** here; earlier sections must not be replaced when adding new work—extend at the end.
...
*Append new sections at the end of this file when milestones land; preserve Phase 0–3 baseline.*
